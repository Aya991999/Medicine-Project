...
namespace Utilities
{
    public class MimeTypes
    {
        ...
        public static string RemoveChar(string fileName)
        {
            ...
            fileName = fileName.Contains("U+0005C") ? fileName.Remove(fileName.LastIndexOf("U+0005C")) : fileName;
            fileName = fileName.Contains("&#x5c;") ? fileName.Remove(fileName.LastIndexOf("&#x5c;")) : fileName;
            fileName = fileName.Contains("&#92;") ? fileName.Remove(fileName.LastIndexOf("&#92;")) : fileName;
            fileName = fileName.Contains("&bsol;") ? fileName.Remove(fileName.LastIndexOf("&bsol;")) : fileName;
            fileName = fileName.Contains("\\005C") ? fileName.Remove(fileName.LastIndexOf("\\005C")) : fileName;
            fileName = fileName.Contains("-") ? fileName.Remove(fileName.LastIndexOf("-")) : fileName;
            return fileName;
        }
    }
